...
namespace CommonUtility.Editor
{
    public class CustomUpdateSpriteAsset
    {
        ...
        {
            return Selection.activeObject != null && Selection.activeObject.GetType() == typeof(TMP_SpriteAsset);
        }

        [MenuItem("Assets/Update TMP_SpriteAsset")]
        private static void UpdateSpriteAsset(MenuCommand _)
        {
            TMP_SpriteAsset asset = (TMP_SpriteAsset)Selection.activeObject;
            UpdateSpriteAsset(asset);
        }

        private static void UpdateSpriteAsset(TMP_SpriteAsset spriteAsset)
        {
